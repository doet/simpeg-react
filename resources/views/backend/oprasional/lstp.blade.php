    ...
    // });
      ...
      postData: parameters,
        ...
        {name:'Cargo',index:'Cargo',width:50, editable: false, align: 'center',search:false,hidden:true},
				...
				{name:'lstp_req',index:'lstp_req',width:50, editable: false, align: 'center',search:false},
				{name:'lstp_aprv',index:'lstp_aprv',width:50, editable: false, align: 'center',search:false},
