...
<script type="text/javascript">
    ...
    var end = $('#pedate').html();
      ...
      postData: parameters,
			...
			sortorder: 'desc',
			height: 'auto',
			colNames:['id','Date Issue','PPJK','AGEN','Kapal','Jetty','ETA','ETD','Asal','Tujuan','Etmal','Cargo','Muatan','Date Req','Date Aprv','LSTP'],
			colModel:[
				...
				{name:'ETA',index:'ETA', width:80, editable: false, align: 'center',search:false,hidden:true},
				{name:'ETD',index:'ETD', width:80, sortable:false, align: 'center',search:false,hidden:true},
				{name:'Asal',index:'Asal', width:70, editable: false,search:false,hidden:true},
        {name:'Tujuan',index:'Tujuan', width:70, editable: false,search:false,hidden:true},
        {name:'Etmal',index: 'Etmal', width: 50,editable: false, align: 'center',search:false,hidden:true},
        {name:'Cargo',index:'Cargo',width:50, editable: false, align: 'center',search:false,hidden:true},
				{name:'Muatan',index:'Muatan',width:50, editable: false, align: 'center',search:false,hidden:true},
				{name:'req',index:'req',width:50, editable: false, align: 'center',search:false},
				{name:'aprv',index:'aprv',width:50, editable: false, align: 'center',search:false},
				{name:'lstp',index:'lstp',width:50, editable: false, align: 'center',search:false}
			],
		...
		jQuery(grid_selector).jqGrid('navGrid',pager_selector,
			...
			},
			{
				...
				onClickButton:function(){
					...
					if(gsr){
						req = $(this).jqGrid('getCell',gsr,'req');
						aprv = $(this).jqGrid('getCell',gsr,'aprv');
