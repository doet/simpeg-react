    ...
    <body style="font-size:12px;">
        ...
        <main>
          ...
          <div style="page-break-after: avoid;">
            <div style="position:absolute; top:124; left:240;"><?php echo $query[0]->no_kwn ?></div>
            ...
            <div style="position:absolute; top:173; right:270; font-size: 14px;"><?php echo number_format($total) ?></div>
            ...
            <div style="position:absolute; top:326; left:440;"><?php echo date('d - M - Y',$query[0]->tgl_pay) ?></div>
            <div style="position:absolute; top:433; left:440; text-align: center; font-size: 10px;"><b>H.ARIEF RIVA'I, SH, MH, M.SI</b><br>Derektur Utama<</div>
          </div>
